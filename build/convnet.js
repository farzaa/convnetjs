...
(function(global) {
  ...
  // img is a DOM element that contains a loaded
  // returns a Vol of size (W, H, 4). 4 is for RGBA
  var img_to_vol = function(img, convert_grayscale) {
    console.log("Width image (img_to_vol)... ", img.width)
    console.log("Height image (img_to_vol)... ", img.height)
    console.log('img_to_vol convnetjs');
    console.log("In img_to_vol image is type of.. " + typeof(img))
    ...
    try {
      ...
      if (e.name === "NS_ERROR_NOT_AVAILABLE") {
        ...
        console.log("Returning first try...");
        return false;
      } else {
        throw e;
      }
    ...
    try {
      ...
      if(e.name === 'IndexSizeError') {
          console.log("Returning second try...");
    ...
    console.log("Width canvas (img_to_vol)... ", canvas.width)
    console.log("Height canvas (img_to_vol)... ", canvas.height)
    ...
    console.log("Size...");
    console.log("Converted img_to_vol with width " + String(W) + " and height " + String(H));
    x.w = pv;
...
(function(global) {
  ...
  Trainer.prototype = {
    train: function(x, y) {
      ...
      // console.log("COST LOSS... ", cost_loss)
      //console.log("CLASS... ", y)
